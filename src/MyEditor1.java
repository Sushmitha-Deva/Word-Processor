 ...
 */
public class MyEditor1 {


	private static JFrame frame__;
	...
	private static class CutFileListener implements ActionListener {
	...
	private static class CopyFileListener implements ActionListener {
	...
	private static class PasteFileListener implements ActionListener {
	...
	private static class AboutFileListener implements ActionListener {



		@Override
		public void actionPerformed(ActionEvent e) {
			JOptionPane.showMessageDialog(frame__,"This ia a basic Word Processor");
		}
	}
...
//REGISTER DICTIONARY
		...
		//SpellChecker.register(jTextField);
		SpellChecker.register(editor__);
//SpellChecker.register(jTextPane1);
	...
	private void configurePopUp(){
		...
		sco.setIgnoreAllCapsWords(false);
		sco.setIgnoreWordsWithNumbers(true);
		JPopupMenu popup = SpellChecker.createCheckerPopup(sco);
		editor__.addMouseListener(new PopupListener(popup));
	}
	private void createAndShowGUI() {
		...
		boldButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bold.png")));
		...
		italicButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/italic.png")));
		...
		underlineButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/underline.png")));
		...
		colorButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/color.png")));
		...
		insertPictureButton.setHideActionText(true);
		insertPictureButton.addActionListener(new PictureInsertActionListener());

		insertPictureButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pi.png")));
		insertPictureButton.setBorderPainted(false);
		insertPictureButton.setFocusPainted(false);
		...
		deletePictureButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pd.png")));
		deletePictureButton.setBorderPainted(false);
		deletePictureButton.setFocusPainted(false);
		...
		bulletInsertButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bi.png")));
		bulletInsertButton.setBorderPainted(false);
		bulletInsertButton.setFocusPainted(false);
		bulletInsertButton.setContentAreaFilled(false);
		...
		bulletRemoveButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br.png")));
		bulletRemoveButton.setBorderPainted(false);
		bulletRemoveButton.setFocusPainted(false);
		bulletRemoveButton.setContentAreaFilled(false);
		...
		numbersInsertButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ni.png")));
		numbersInsertButton.setBorderPainted(false);
		numbersInsertButton.setFocusPainted(false);
		numbersInsertButton.setContentAreaFilled(false);
		...
		numbersRemoveButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/nr.png")));
		numbersRemoveButton.setBorderPainted(false);
		numbersRemoveButton.setFocusPainted(false);
		numbersRemoveButton.setContentAreaFilled(false);
		...
		aboutItem.addActionListener(new AboutFileListener());
		//aboutItem.getAccessibleContext().setAccessibleDescription("This is a basic Word Processor");
	...
	private class OpenFileListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			// If the user cancelled the operation
				...
				JOptionPane.showMessageDialog(frame__, "the user cancelled the operation");
		}
/*
		@Override
		public void actionPerformed(ActionEvent e) {
 ...
 */
	...
	private static class PrintFileListener implements ActionListener {
